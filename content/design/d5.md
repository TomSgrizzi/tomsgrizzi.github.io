...
+ [Papers](https://tomsgrizzi.onrender.com/papers/) – Published and unpublished research papers, stored in the `papers` subfolder
+ [Courses](https://tomsgrizzi.onrender.com/courses/) – Undergraduate and graduate courses, stored in the `courses` subfolder
+ [Design](https://tomsgrizzi.onrender.com/design/) – Design projects, stored in the `design` subfolder
...
To add a new paper to the website, for instance , add a file `new_paper.md` into the `papers` subfolder. That new paper will automatically be listed on the [page with the other papers](https://tomsgrizzi.onrender.com/papers/). It is convenient to [use archetypes](#archetypes) to generate new files easily. 
...
A list of all the [tags](https://tomsgrizzi.onrender.com/tags/) (or keywords) used in papers and courses is automatically generated and added to the website. The tags are accessible from the menu bar. Tags can be added to any webpage with the `tags` parameter. Tags also appear at the bottom of the page in small gray buttons. 
...
The website's domain name `https://tomsgrizzi.onrender.com/` is registered with
